...
String serialbridge_node_hex_to_string(uint8_t node_hex)
{
	...
	String node_type = (node_hex & 0b10000000) ? "LIGHT_" : "ULTRASONIC_";
	node_str += node_type;

	uint8_t node_id = node_hex & 0b01111111;
	if (node_id < 10)
		node_str += "0";
	node_str += String(node_id);
...
{
	return (node_hex & 0b10000000) ? "light" : "ultrasonic";
}
